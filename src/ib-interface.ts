...
export interface IBSheetFunctions {
  ...
  applySaveResult(
    result: number | { result: number; message?: string; response?: object; files?: unknown[] },
    message?: string,
    response?: object,
    files?: unknown[]
  ): boolean
  ...
  calculate(
    render?:
      | boolean
      | number
      | { render?: boolean | number; calconly?: boolean | number; fixedonly?: boolean | number },
    calconly?: boolean | number,
  ...
  clearRange(range: unknown[] | { range: unknown[] }): void
  clearSelection(): void
  clearSort(): void
  clear(): void
  closeDialog(): void
  copyRow(
    row?:
      ...
      | {
          ...
          parent?: IBRow
          child?: boolean | number
          forceVisible?: boolean | number
        },
    next?: IBRow,
    empty?: boolean | number,
    parent?: IBRow,
  ...
  deleteRow(
    row: IBRow | { row: IBRow; del?: number; valid?: boolean | number; visible?: boolean | number },
    del?: number,
    valid?: boolean | number,
    visible?: boolean | number
  ): boolean
  ...
  disable(
    hard?: boolean | number | { hard?: boolean | number; fixedInSheet?: boolean | number },
    fixedInSheet?: boolean | number
  ): void
  dispose(): void
  doFilter(
    cols:
  ...
  doPivotFilter(
    cols: string | { cols: string; vals: string; operators: string },
    vals?: string,
    operators?: string
  ): void
  doPrint(
  ...
  doSave(
    url:
      ...
      | {
          ...
          saveMode?: number
          col?: string
          urlEncode?: boolean | number
          delim?: string
          queryMode?: number
          reqHeader?: object
          quest?: boolean | number
          sync?: boolean | number
          validRequired?: boolean | number
          saveAttr?: string
          useLevel?: boolean | number
          questCallback?: Function
          timeout?: number
          traditional?: boolean | number
          saveExtraAttr?: boolean | number
        },
    param?: string,
    saveMode?: number,
    col?: string,
  ...
  // enable(): void;
  endEdit(save?: boolean | number | { save?: boolean | number }): unknown
  ...
  extractDataText(
    excludeHideData?: boolean | number | { excludeHideData?: boolean | number }
  ): string
  findRows(
    action: string | { action: string; match?: boolean | number; callback?: Function },
  ...
  fitSize(
    col: string | { col: string; norender?: boolean; rows?: IBRow[] },
    norender?: boolean,
    rows?: IBRow[]
  ): void
  focus(
    row:
      ...
      | {
          ...
          col: string
          pagepos?: number
          ignoreEvent?: boolean | number
          triggerOnFocus?: boolean | number
        },
    col?: string,
    pagepos?: number,
    ignoreEvent?: boolean | number,
  ...
  getAttribute(
    row?: IBRow | { row?: IBRow; col?: string; attr?: string },
    col?: string,
    attr?: string
  ): number | string
  ...
  getChangedData(
    row?: IBRow | { row?: IBRow; attrs?: string[]; dataonly?: boolean | number },
    attrs?: string[],
    dataonly?: boolean | number
  ): string
  getChildRows(row: IBRow | { row: IBRow; maxLevel?: number }, maxLevel?: number): IBRow[]
  getColByIndex(
    index: number | { index: number; includeHideCol?: boolean | number },
    includeHideCol?: boolean | number
  ): string
  getColIndex(
    col: string | { col: string; includeHideCol?: boolean | number },
    includeHideCol?: boolean | number
  ): number
  getColLeft(col: string | { col: string }): number
  getCols(
    attr1?: string | { attr1?: string; attr2?: string; seq?: boolean | number },
    attr2?: string,
    seq?: boolean | number
  ): string[]
  ...
  getFirstCol(
    section?: number | { section?: number; includeHideCol?: boolean | number },
    includeHideCol?: boolean | number
  ): string
  ...
  getFocusedRow(): IBRow
  getFormat(
    row: IBRow | { row: IBRow; col: string; edit?: boolean | number },
    col?: string,
    edit?: boolean | number
  ): string
  ...
  getLocale(): string
  getMergeRange(row: IBRow | { row: IBRow; col: string }, col?: string): unknown[]
  ...
  getRowValue(
    row: IBRow | { row: IBRow; saveExtraAttr?: boolean | number; saveAttr?: string },
    saveExtraAttr?: boolean | number,
    saveAttr?: string
  ): object
  ...
  getRowsByDup(
    cols:
      ...
      | {
          ...
          emptyVal?: boolean | number
          subsum?: boolean | number
          exceptStatus?: string
        },
    firstOnly?: boolean | number,
    emptyVal?: boolean | number,
  ...
  getScrollTop(): number
  getSelectedRanges(
    rowtype?: number | { rowtype?: number; coltype?: number },
    coltype?: number
  ): object
  getSelectedRows(type?: number | { type?: number; attr?: string }, attr?: string): unknown[]
  ...
  hideRow(
    row:
      ...
      | {
          row: IBRow
          del?: boolean | number
          norender?: boolean | number
          nomerge?: boolean | number
        },
    del?: boolean | number,
    norender?: boolean | number,
    nomerge?: boolean | number
  ...
  makeSubTotal(
    subTotalRows:
      ...
      | {
          subTotalRows: object[]
          usermerge?: boolean | number
          excludeSubTotalRowCount?: boolean | number
        },
    usermerge?: boolean | number,
    excludeSubTotalRowCount?: boolean | number
  ): void
  moveCol(
    col:
      | string
      | { col: string; tocol: string; right?: boolean | number; norender?: boolean | number },
    tocol?: string,
  ...
  refreshPage(
    page: IBPage | { page: IBPage; always?: boolean | number },
    always?: boolean | number
  ): void
  refreshRow(row: IBRow | { row: IBRow }): void
  reloadData(func?: Function | { func?: Function }): void
  reload(callback?: Function | { callback?: Function }): void
  removeCol(
    col: string | { col: string; render?: boolean | number },
    render?: boolean | number
  ): void
  removeAll(): void
  ...
  removeRow(
    row: IBRow | { row: IBRow; nomerge?: boolean | number; norender?: boolean | number },
    nomerge?: boolean | number,
    norender?: boolean | number
  ): void
  ...
  renderBody(): void
  rerender(
    scroll?: boolean | number | { scroll?: boolean | number; sync?: boolean | number },
    sync?: boolean | number
  ): void
  revertCell(
    row: IBRow | { row: IBRow; col: string; render?: boolean | number },
    col?: string,
    render?: boolean | number
  ): void
  revertData(
    remainAddRow?: boolean | number | { remainAddRow?: boolean | number; sync?: boolean | number },
    sync?: boolean | number
  ): void
  revertRow(row: IBRow | { row: IBRow; render?: boolean | number }, render?: boolean | number): void
  saveCurrentInfo(): boolean
  selectAllRows(
    select?: boolean | number | { select?: boolean | number; ignoreEvent?: boolean | number },
    ignoreEvent?: boolean | number
  ): boolean
  selectCell(
    row:
  ...
  setAllCheck(
    col: string | { col: string; val: boolean | number; ignoreEvent?: boolean | number },
    val?: boolean | number,
    ignoreEvent?: boolean | number
  ): string
  setAttribute(
    row?:
      | IBRow
      | { row?: IBRow; col?: string; attr: string; val: unknown; render?: boolean | number },
    col?: string,
    attr?: string,
    val?: unknown,
    render?: boolean | number
  ...
  setAutoMerge(
    dataMerge?:
      ...
      | {
          ...
          headMerge?: number
          footMerge?: number
          headPrevColumnMerge?: boolean | number
          footPrevColumnMerge?: boolean | number
        },
    headerMerge?: number,
    prevColumnMerge?: number,
    fixPrevColumnMerge?: string,
  ...
  setCellStyle(
    row?: IBRow | { row?: IBRow; col?: string; styleAttr: object; render?: boolean | number },
    col?: string,
    styleAttr?: object,
    render?: boolean | number
  ): void
  setCheck(
    row: IBRow | { row: IBRow; col: string; val: boolean | number; valid?: boolean | number },
    col?: string,
    val?: boolean | number,
    valid?: boolean | number
  ): boolean
  ...
  setExpandRow(
    row: IBRow | { row: IBRow; col?: string; expand?: boolean | number },
    col?: string,
    expand?: boolean | number
  ): boolean
  setFilter(
    name: string | { name: string; filter: string | Function; render?: boolean | number },
    filter?: string | Function,
    render?: boolean | number
  ): unknown[]
  setFixedBottom(
    count?: number | { count?: number; render?: boolean | number },
    render?: boolean | number
  ): boolean
  setFixedCols(
    left?:
      | number
      | { left?: number; right?: number; reMerge?: boolean | number; sync?: boolean | number },
    right?: number,
    reMerge?: boolean | number,
    sync?: boolean | number
  ): boolean[]
  setFixedLeft(
    count?: number | { count?: number; reMerge?: boolean | number; sync?: boolean | number },
    reMerge?: boolean | number,
    sync?: boolean | number
  ): boolean
  setFixedRight(
  ...
  setFormulaRowPosition(
    pos: number | { pos: number; norender?: boolean | number },
    norender?: boolean | number
  ): boolean
  setFormulaRow(
    val:
  ...
  setIconCheck(
    row: IBRow | { row: IBRow; col: string; val?: boolean | number },
    col?: string,
    val?: boolean | number
  ): void
  setInfoRow(
  ...
  setLocale(
    code:
      | string
      | { code: string; load?: boolean | number; path?: string; render?: boolean | number },
    load?: boolean | number,
    path?: string,
    render?: boolean | number
  ): boolean
  ...
  setMergeRange(
    row1: IBRow | { row1: IBRow; col1: string; row2: IBRow; col2: string },
    col1?: string,
    row2?: IBRow,
    col2?: string
  ): void
  ...
  setMessage(
    key: string | { key: string; type: string; message: string },
    type?: string,
    message?: string
  ): object
  setRowValue(row: IBRow | { row: IBRow; data: object }, data?: object): void
  setScale(
    val?: number | { val?: number; render?: boolean | number },
    render?: boolean | number
  ): void
  ...
  setSelectionSummaryInfoElement(
    element: HTMLElement | string | { element: HTMLElement | string; opt?: object },
    opt?: object
  ): boolean
  setSize(size: string | { size: string }): void
  setString(
    row: IBRow | { row: IBRow; col: string; val: string; render?: boolean | number },
    col?: string,
    val?: string,
    render?: boolean | number
  ): void
  setTheme(
    prefix: string | { prefix: string; csspath: string; render?: boolean | number },
    csspath?: string,
    render?: boolean | number
  ): void
  ...
  setValue(
    row:
      ...
      | {
          ...
          val: unknown
          render?: boolean | number
          ignoreEvent?: object | boolean | number
        },
    col?: string,
    val?: unknown,
    render?: boolean | number,
  ...
  showCol(
    col?: string | { col?: string; merge?: boolean | number; render?: boolean | number },
    merge?: boolean,
    render?: boolean | number
  ): void
  showDialog(
    row:
      | IBRow
      | { row: IBRow; col: string; dialog: IBDialog; pos?: IBPosition; always?: boolean | number },
    col?: string,
    dialog?: IBDialog,
    pos?: IBPosition,
    always?: boolean | number
  ...
  showGroupRow(
    cols?: string | object | { cols?: string | object; format?: string },
    format?: string
  ): boolean
  showHint(
    row: IBRow | { row: IBRow; col: string; staticMode?: boolean | number },
    col?: string,
    staticMode?: boolean | number
  ): boolean
  ...
  showMessage(
    message: string | { message: string; importance?: number; type?: number },
    importance?: number,
    type?: number
  ): void
  ...
  showProgress(
    caption:
      | string
      | { caption: string; text: string; cancel?: string; pos?: number; cnt?: number },
    text?: string,
    cancel?: string,
    pos?: number,
    cnt?: number
  ...
  showRow(
    row: IBRow | { row: IBRow; norender?: boolean | number },
    norender?: boolean | number
  ): void
  showTimePicker(
    row: IBRow | { row: IBRow; col: string; format?: string },
    col?: string,
    format?: string
  ): boolean
  showTip(tip: string | { tip: string }): void
  showTreeLevel(
    level: number | { level: number; ignoreEvent?: boolean | number; childMode?: number },
    ignoreEvent?: boolean | number,
    childMode?: number
  ): void
  startEdit(
    row?: IBRow | { row?: IBRow; col?: string; empty?: boolean | number; valid?: boolean | number },
    col?: string,
    empty?: boolean | number,
    valid?: boolean | number
  ): void
  ...
  unbindAll(): void
  updateClientPaging(
    length: number | { length: number; render?: boolean | number },
    render?: boolean | number
  ): boolean
...
export interface IBSheetEvents {
  ...
  onAfterRowDelete?(evtParams: {
    sheet: IBSheetInstance
    row: IBRow
    type: number
    eventName: string
  }): void
  onAfterRowMoveToSheet?(evtParams: {
    sheet: IBSheetInstance
    row: IBRow
    tosheet: IBSheetInstance
    torow: IBRow
    copy: boolean
    eventName: string
  }): number
  ...
  onAfterSectionResize?(evtParams: {
    sheet: IBSheetInstance
    section: number
    eventName: string
  }): void
  ...
  onSelectFile?(evtParams: {
    sheet: IBSheetInstance
    type: string
    filename: string
    eventName: string
  }): void
  onSelectMenu?(evtParams: {
    sheet: IBSheetInstance
    row: IBRow
    col: string
    result: string
