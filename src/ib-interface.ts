...
interface IBSheetFunctions {
  ...
  doSave(url: string|{url: string, param?: string, saveMode?: number, col?: string, urlEncode?: boolean|number, delim?: string, queryMode?: number, reqHeader?: object, quest?: boolean|number, sync?: boolean|number, validRequired?: boolean|number, saveAttr?: string, useLevel?: boolean|number, questCallback?: Function, timeout?: number, traditional?: boolean|number, saveExtraAttr?: boolean|number}, param?: string, saveMode?: number, col?: string, urlEncode?: boolean|number, delim?: string, queryMode?: number, reqHeader?: object, quest?: boolean|number, sync?: boolean|number, validRequired?: boolean|number, saveAttr?: string, useLevel?: boolean|number, questCallback?: Function, timeout?: number, traditional?: boolean|number, saveExtrAttr?: boolean|number): void;
  doSearchPaging(url: string|{url: string, pageParam?: string, param?: string, reqHeader?: object, method?: string, callback?: Function, timeout?: number, sync?: boolean|number, strictParse?: boolean|number, traditional?: boolean|number, restapi?: boolean|number, cPage?: number, pageLengthParam?: string, beforeSend?: Function, orderByParam: string}, pageParam?: string, param?: string, reqHeader?: object, method?: string, callback?: Function, timeout?: number, sync?: boolean|number, strictParse?: boolean|number, traditional?: boolean|number, restapi?: boolean|number, cPage?: number, pageLengthParam?: string, beforeSend?: Function, orderByParam?: string): void;
  doSearch(url: string|{url: string, param?: string, method?: string, append?: boolean|number, reqHeader?: object, callback?: Function, timeout?: number, sync?: number, next?: IBRow, strictParse?: boolean|number, traditional?: boolean|number, parent?: IBRow}, param?: string, method?: string, append?: boolean|number, reqHeader?: object, callback?: Function, timeout?: number, sync?: boolean|number, next?: IBRow, strictParse?: boolean|number, traditional?: boolean|number, parent?: IBRow): void;
  ...
  findRows(action: string|{action: string, match?: boolean|number, callback?: Function}, match?: boolean|number, callback?: Function): void;
  ...
  loadSearchData(data: any[]|{data: any[], append?: boolean|number, callback?: Function, sync?: boolean|number, next?: IBRow, strictParse?: boolean|number, parent?: IBRow, ignoreEvent?: boolean|number}, append?: boolean|number, callback?: Function, sync?: boolean|number, next?: IBRow, strictParse?: boolean|number, parent?: IBRow, ignoreEvent?: boolean|number): void;
  makePivotTable(criterias?:object|{criterias?:object, init: object, format?: string, type?: string, callback?: Function, hideTotal: object}, init?: object, format?: string, type?: string, callback?: Function, hideTotal?: object): void;
  ...
  setFilter(name: string|{name: string, filter: string|Function, render?: boolean|number}, filter?: string|Function, render?: boolean|number): any[];
  ...
  showCalendar(row: IBRow|{row: IBRow, col: string, calendar?: IBCalendar, pos?: IBPosition, func?: Function, date?: string, always?: boolean|number}, col?: string, calendar?: IBCalendar, pos?: IBPosition, func?: Function, date?: string, always?: boolean|number): IBCalendar;
  ...
  showMenu(row: IBRow|{row: IBRow, col: string, menu: IBMenu, pos?: IBPosition, func?: Function, init?: string[], always?: boolean|number, cursor?: boolean|number}, col?: string, menu?: IBMenu, pos?: IBPosition, func?: Function, init?: string[], always?: boolean|number, cursor?: boolean|number): IBMenu|null;
  showMessageTime(message: string|{message: string, time?: number, func?: Function, buttons?: string[], importance?: number, type?: number}, time?: number, func?: Function, buttons?: string[], importance?: number, type?: number): void;
...
interface IBSheetEvents {
  ...
  onShowMessage?(evtParams:{sheet: IBSheetInstance, messageTag: object, message: string, isConfirm: boolean, time: number, buttons: string[], callback: Function, eventName: string}): boolean;
